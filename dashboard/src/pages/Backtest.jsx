...
import { Play, Calendar, DollarSign, Percent, TrendingUp, TrendingDown } from 'lucide-react';
import {
  LineChart,
  Line,
  XAxis,
...
const backtestData = {
  ...
  monthlyReturns: [2.34, -2.49, 5.82, 3.07, 3.14, -2.19, 4.88, 3.20, 2.89, 2.72, -5.38, null],
  tradeStats: [
              ...
              <div key={stat.month} className="border-b border-dark-border pb-4 last:border-0 last:pb-0">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex items-center gap-4 text-sm">
                    ...
                    <span className="text-gray-400">
                      WR: {((stat.wins / stat.trades) * 100).toFixed(0)}%
                    </span>
                  </div>
                </div>
                <div className="flex items-center gap-6 text-xs">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-white font-mono">{(stat.avgWin * stat.wins / Math.abs(stat.avgLoss * stat.losses)).toFixed(2)}</span>
                  </div>
                </div>
              </div>
            ))}
